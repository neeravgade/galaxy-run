'''I will create a game with pygame. Player will be able to go through multiple rooms and walls
and try to avoid obstacles. I'm not sure what obstacles I want to add, but they will get progressively tougher
